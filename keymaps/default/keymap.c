...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = { { C_X,     C_C,     C_V,     C_Z,     C_Y,     C_S,     KC_MPRV, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, KC_SLSH, KC_EQL,  KC_TILD, },
              ...
              { LC_F20,  OLCAG,   KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX, W_SP,    XXXXXXX, XXXXXXX, C_CAPS,  LSA_P,   XXXXXXX, QWERT,   OHYPR,   }, },
              /*------------------------------------------------------------------------------------------------------------------------------*/
  [_QWERTY]={ { KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SLSH, KC_EQL,  _______, },
              ...
              { KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX, KC_SPC,  XXXXXXX, XXXXXXX, KC_LCTL, KC_RALT, XXXXXXX, QWERT,   KC_RGUI, }, },
              /*------------------------------------------------------------------------------------------------------------------------------*/
  [_NUM]  = { { KC_NO,   KC_1,    KC_2,    KC_3,    KC_PEQL, _______, _______, _______, _______, _______, _______, _______, _______, _______, },
              ...
              { KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX, KC_SPC,  XXXXXXX, XXXXXXX, KC_LCTL, KC_RALT, XXXXXXX, KC_NO,   KC_RGUI, }, },
              /*------------------------------------------------------------------------------------------------------------------------------*/
  [_CON]  = { { KC_NO,   _______, _______, _______, _______, _______, RGB_RMOD,RGB_MOD, RGB_TOG, RGB_SPD, RGB_SPI, RGB_VAD, RGB_VAI, _______, },
              ...
              { KC_LCTL, KC_LGUI, C_ST,    XXXXXXX, XXXXXXX, XXXXXXX, FN_ENT,  XXXXXXX, XXXXXXX, KC_LCTL, KC_RALT, XXXXXXX, KC_NO,   KC_RGUI, }, },
              /*------------------------------------------------------------------------------------------------------------------------------*/
