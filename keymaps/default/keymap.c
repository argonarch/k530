...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = {
    ...
    { LC_F20,  OLCAG,   FN_ALT,  XXXXXXX, XXXXXXX, XXXXXXX, W_SP,    XXXXXXX, XXXXXXX, C_CAPS,  LSA_P,   XXXXXXX, QWERT,   KC_LALT, }, },
    /*------------------------------------------------------------------------------------------------------------------------------*/
  [_QWERTY]={
    ...
    { KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX, KC_SPC,  XXXXXXX, XXXXXXX, KC_LCTL, LSA_P,   XXXXXXX, QWERT,   KC_RGUI, }, },
    /*------------------------------------------------------------------------------------------------------------------------------*/
  [_NUM]  = {
    { KC_F13,  KC_1,    KC_2,    KC_3,    KC_PEQL, _______, _______, _______, _______, _______, _______, _______, _______, _______, },
    ...
    /*------------------------------------------------------------------------------------------------------------------------------*/
  [_CON]  = {
    { KC_F15,  _______, _______, _______, _______, _______, RGB_RMOD,RGB_MOD, RGB_TOG, RGB_SPD, RGB_SPI, RGB_VAD, RGB_VAI, _______, },
    ...
    { KC_LCTL, KC_LGUI, C_ST,    XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, KC_LCTL, KC_RALT, XXXXXXX, KC_F16,  KC_RGUI, }, },
    /*------------------------------------------------------------------------------------------------------------------------------*/
  [_FN]   = {
  ...
  [_SYMBOL]={
    ...
    { _______, XXXXXXX, KC_PWR,  KC_SLEP, KC_WAKE, _______, _______, _______, _______, _______, KC_F21,  KC_F22,  XXXXXXX, _______, },
